    ...
    return (
        <div className="bg-black">
            ...
            <div className="grid grid-cols-4 gap-4 mx-4 ">
                ...
                <div><img src={Kimchi} alt="Image of a Kimchi Fried Rice" className="border-2 border-yellow-600 border-solid"/></div>
                ...
                <div><img src={oldFashion} alt="Image of an old fashion drink" className="border-2 border-yellow-600 border-solid"/></div>
